...
import nl.davebeerensdesigns.hosting_management.assembler.UserDtoAssembler;
...
import nl.davebeerensdesigns.hosting_management.service.UserService;
...
@CrossOrigin
@RestController
@RequestMapping("/wp-json/hm/v1/users")
